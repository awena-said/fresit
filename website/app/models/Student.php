...
class Student
{
    ...
    public function createApplication($applicationData)
    {
        try {
            ...
            // Insert application
            $sql = "INSERT INTO applications (id, student_name, student_email, student_phone, class_id, class_type, start_date, experience_level, additional_notes, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending')";
