...
try {
    ...
    echo "Step 5: Application model loads<br>";
} catch (Exception $e) {
    echo "Step 5: Application model failed - " . $e->getMessage() . "<br>";
    exit;
}
...
try {
    ...
    echo "Step 6: Application instance created<br>";
} catch (Exception $e) {
    echo "Step 6: Application instance failed - " . $e->getMessage() . "<br>";
    exit;
}
...
try {
    ...
    echo "Step 7: HomeController loads<br>";
} catch (Exception $e) {
    echo "Step 7: HomeController failed - " . $e->getMessage() . "<br>";
    exit;
}
...
try {
    ...
    echo "Step 8: HomeController instance created<br>";
} catch (Exception $e) {
    echo "Step 8: HomeController instance failed - " . $e->getMessage() . "<br>";
