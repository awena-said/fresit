...
<body>
    ...
    <header class=\"header\">
        <nav class=\"button-section\" role=\"navigation\">
            ...
            <a class=\"link\" href=\"/fresit/reviews\" tabindex=\"0\" aria-label=\"Go to Reviews Page\">
                REVIEWS
            </a>
            <a class=\"link\" href=\"/fresit/booking\" tabindex=\"0\" aria-label=\"Book Classes\">
                BOOK CLASSES
            </a>
            ";
        // line 56
        if (($context["user"] ?? null)) {
            // line 57
            yield "                ";
            if ((CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "type", [], "any", false, false, false, 57) == "staff")) {
                // line 58
                yield "                    <a class=\"link\" href=\"/fresit/staff/dashboard\" tabindex=\"0\" aria-label=\"Staff Dashboard\">
                        STAFF PORTAL
                    </a>
                ";
            } else {
                // line 62
                yield "                    <a class=\"link\" href=\"/fresit/student/dashboard\" tabindex=\"0\" aria-label=\"Student Dashboard\">
                        MY ACCOUNT
                    </a>
                ";
            }
            ...
            // line 67
            yield "                <a class=\"link\" href=\"/fresit/staff/login\" tabindex=\"0\" aria-label=\"Staff Login\">
                    STAFF LOGIN
                </a>
            ";
        }
    ...
    {
        return array (  231 => 77,  221 => 12,  210 => 6,  144 => 78,  142 => 77,  134 => 71,  128 => 67,  125 => 66,  119 => 62,  113 => 58,  110 => 57,  108 => 56,  63 => 13,  61 => 12,  52 => 6,  45 => 1,);
    }
...
<body>
    ...
    <header class=\"header\">
        <nav class=\"button-section\" role=\"navigation\">
            ...
            {% if user %}
                {% if user.type == 'staff' %}
                    <a class=\"link\" href=\"/fresit/staff/dashboard\" tabindex=\"0\" aria-label=\"Staff Dashboard\">
                        STAFF PORTAL
                    </a>
                {% else %}
                    <a class=\"link\" href=\"/fresit/student/dashboard\" tabindex=\"0\" aria-label=\"Student Dashboard\">
                        MY ACCOUNT
                    </a>
                {% endif %}
            {% else %}
                <a class=\"link\" href=\"/fresit/staff/login\" tabindex=\"0\" aria-label=\"Staff Login\">
                    STAFF LOGIN
                </a>
            {% endif %}
        </nav>
