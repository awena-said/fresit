...
class Application
{
    ...
    public function create($data)
    {
        try {
            ...
            error_log("Database error in Application::create: " . $e->getMessage());
            return false;
        }
    }
    ...
    public function getById($id)
    {
        try {
            ...
            error_log("Database error in Application::getById: " . $e->getMessage());
            return null;
        }
    }
    ...
    public function getAll()
    {
        try {
            ...
            error_log("Database error in Application::getAll: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function updateStatus($id, $status, $reviewedBy = null)
    {
        try {
            ...
            error_log("Database error in Application::updateStatus: " . $e->getMessage());
            return false;
        }
    }
} 